<?php
function hk_register_custom_post_types() {
    // Register Staff CPT
    $labels = array(
    ...
    register_post_type( 'hk-staff', $args );
...
function hk_register_taxonomies() {
    ...
    register_taxonomy( 'hk-staff-category', array( 'hk-staff' ), $args );
    ...
    register_taxonomy( 'hk-student-category', array( 'hk-student' ), $args );
}
add_action( 'init', 'hk_register_taxonomies');
?>